<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="IAInternalSelfCheck.aspx.vb" Inherits="NYSInternalAdmin.IAInternalSelfCheck" %>
...
<body>
    ...
    <div>
     ...
     <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <asp:Label ID="lblBookingDetails" runat="server" 
             CssClass="nyslabelHeaderCentre" Style="z-index: 101; left: 4px; position: absolute;
                top: -2px; width: 1010px;" Text="Self/Quality Check"></asp:Label>
     ...
     <asp:Image ID="imHover" runat="server" 
         ...
         <rsweb:ReportViewer ID="rvSelfCheck" runat="server" BackColor="White" 
            ...
            LinkDisabledColor="LightGray" ToolBarItemBorderStyle="None" 
             ...
             <LocalReport ReportPath="Reports\repInternalSelfCheck.rdlc">
                 <DataSources>
                     <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" 
                         Name="dsInternalSelfCheck_internal_selfCheck" />
                 </DataSources>
             </LocalReport>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                ...
                TypeName="NYSInternalAdmin.dsInternalSelfCheckTableAdapters.internal_selfCheckTableAdapter">
                <SelectParameters>
