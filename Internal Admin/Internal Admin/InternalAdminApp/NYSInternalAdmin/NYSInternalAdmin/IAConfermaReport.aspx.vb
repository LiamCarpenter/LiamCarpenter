...
Partial Public Class IAConfermaReport
    Inherits clsNYS
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                Dim dtstart As Date = Now.AddDays(-1)
                ...
                lblBookingDetails.Text = labelText("Hotel Rooms by Booked Date", dtstart.Day, dtstart.Month, dtstart.Year, dtend.Day, dtend.Month, dtend.Year)
            End If
            Me.Title = CStr(Session.Item("clientname")) & " Management Information by NYS Corporate"
        Catch ex As Exception
            handleexception(ex, "IAConfermaReport", Me.Page)
        End Try
    End Sub
    ...
    Private Sub IAConfermaReport_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreRender
        Using New clslogger(log, className, "IAConfermaReport_PreRender")
            Try
                Dim fp As ucReportMenu = DirectCast(LoadControl("UserControls/ucReportMenu.ascx"),  _
                    ucReportMenu)
                fp.pageName = "IAConfermaReport"
