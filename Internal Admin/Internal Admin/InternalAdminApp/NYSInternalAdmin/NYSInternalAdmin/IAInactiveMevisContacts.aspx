<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="IAInactiveMevisContacts.aspx.vb" Inherits="NYSInternalAdmin.IAInactiveMevisContacts" %>
...
<body>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <asp:Label ID="lblBookingDetails" runat="server" CssClass="nyslabelHeaderCentre"
            ...
            Text="Inactive Mevis Users "></asp:Label>
        <asp:Panel ID="pnmain" runat="server" Style="left: 4px; position: absolute; z-index: 100;
            ...
            <asp:Panel ID="pndates" runat="server" CssClass="nyspanels" Style="left: 225px; position: absolute;
                top: 4px; width: 494px; height: 34px; z-index: 10000;">
                <asp:Label ID="lblfrom" runat="server" CssClass="nyslabel" Style="z-index: 103; left: 7px;
                    position: absolute; top: 9px; width: 174px; right: 313px; height: 20px;" 
                    Text="Inactive Since (Enter Date):"></asp:Label>
                <asp:TextBox ID="txtfrom" runat="server" CssClass="nystextbox" Style="z-index: 99;
                    left: 189px; position: absolute; top: 8px; width: 102px;" TabIndex="1"></asp:TextBox>
                <asp:TextBox ID="txtcompany" runat="server" CssClass="nystextbox" Style="z-index: 98;
                    left: 245px; position: absolute; top: 14px; width: 8px; height: 9px;" TabIndex="1"
                    Visible="False"></asp:TextBox>
                <asp:ImageButton ID="btnrefresh" runat="server" CssClass="btnclasshand" ImageUrl="~/images/refresh_out.gif"
                    Style="z-index: 109; left: 338px; position: absolute; top: 6px" TabIndex="3"
                    BorderStyle="None" />
            </asp:Panel>
            ...
            <asp:TextBox ID="txtbossname" runat="server" CssClass="nystextbox" Style="z-index: 98;
                    left: 456px; position: absolute; top: 16px; width: 9px; height: 15px;" 
                TabIndex="1" Visible="False"></asp:TextBox>
             <asp:TextBox ID="txtbossname2" runat="server" CssClass="nystextbox" Style="z-index: 98;
                    left: 482px; position: absolute; top: 13px; width: 9px; height: 15px;" TabIndex="1"
                    Visible="False"></asp:TextBox>
            <rsweb:ReportViewer ID="rvInactiveMevisContacts" runat="server" 
                BackColor="White" CssClass="reportView"
                DocumentMapWidth="100%" Font-Names="Verdana" Font-Size="8pt" 
                Height="600px" InternalBorderStyle="None"
                ...
                ShowZoomControl="False" Style="left: 4px; position: absolute; z-index: 100; top: 44px;
                height: 572px; width: 1002px;" ToolBarItemHoverBackColor="Silver" Width="995px"
                LinkDisabledColor="LightGray" ToolBarItemBorderStyle="None" LinkActiveColor="Blue"
                LinkActiveHoverColor="DeepPink" ShowBackButton="False" InteractiveDeviceInfos="(Collection)"
                WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" 
                EnableTheming="True">
                   <LocalReport ReportPath="Reports\repInactiveMevisContacts.rdlc">
                       <DataSources>
                ...
                TypeName="NYSInternalAdmin.dsInactiveMevisContactsTableAdapters.InactiveMevisContacts_listTableAdapter">
                      <SelectParameters>
                          <asp:ControlParameter ControlID="txtcompany" Name="groupid" PropertyName="Text" 
                              Type="Int32" />
                          <asp:ControlParameter ControlID="txtfrom" Name="beforedate" PropertyName="Text" 
                              Type="String" />
                      </SelectParameters>
