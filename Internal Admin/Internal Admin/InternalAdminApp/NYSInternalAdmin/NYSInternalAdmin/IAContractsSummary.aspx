<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="IAContractsSummary.aspx.vb" Inherits="NYSInternalAdmin.IAContractsSummary" %>
...
<body>
    ...
    <div>
     <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <asp:Label ID="lblBookingDetails" runat="server" 
             CssClass="nyslabelHeaderCentre" Style="z-index: 101; left: 4px; position: absolute;
                top: -2px; width: 1010px;" Text="Contracts Summary"></asp:Label>
       ...
       <asp:TextBox ID="txtfrom" runat="server" CssClass="nystextbox" Style="z-index: 99; left: 127px; position: absolute;
                top: 8px; width: 10px;" TabIndex="1" Visible="false"></asp:TextBox>
     ...
     <asp:Image ID="imHover" runat="server" 
         ...
         <rsweb:ReportViewer ID="rvContractsSummary" runat="server" BackColor="White" 
            ...
            LinkDisabledColor="LightGray" ToolBarItemBorderStyle="None" 
             ...
             <LocalReport ReportPath="Reports\repContractsSummary.rdlc">
                 <DataSources>
