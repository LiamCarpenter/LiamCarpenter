...
Public Class IAEnquiryCancellationFormCheck
    Inherits clsNYS
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                lblBookingDetails.Text = labelText("Cancellation Form Check", dtstart.Day, dtstart.Month, dtstart.Year, dtend.Day, dtend.Month, dtend.Year)
            End If
            Me.Title = "Management Information by NYS Corporate"
        Catch ex As Exception
            handleexception(ex, " IAEnquiryCancellationFormCheck", Me.Page)
        End Try
    End Sub
    ...
    Protected Sub btnrefresh_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles btnrefresh.Click
        Using New clslogger(log, className, "btnrefresh_Click")
            Try
                ...
                rvCancellationCheck.LocalReport.Refresh()
            Catch ex As Exception
                handleexception(ex, " IAEnquiryCancellationFormCheck", Me.Page)
            End Try
        End Using
    ...
    Private Sub IACancellationFormCheck_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreRender
        Using New clslogger(log, className, "IACancellationFormCheck_PreRender")
            Try
                Dim fp As ucReportMenu = DirectCast(LoadControl("UserControls/ucReportMenu.ascx"),  _
                    ucReportMenu)
                fp.pageName = " IAEnquiryCancellationFormCheck"
