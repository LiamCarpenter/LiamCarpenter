...
Partial Public Class IAComplaintsAllFields
    Inherits clsNYS
        ...
        Using New clslogger(log, className, "Page_Load")
            Try
                If Not IsPostBack Then
                    ...
                    lblBookingDetails.Text = labelText("Bookings Analysis", dtstart.Day, dtstart.Month, dtstart.Year, dtend.Day, dtend.Month, dtend.Year)
                End If
                Me.Title = "Management Information by NYS Corporate"
            Catch ex As Exception
                handleexception(ex, "IAComplaintsAllFields", Me.Page)
            End Try
        End Using
    End Sub
    ...
    Protected Sub btnrefresh_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnrefresh.Click
        Using New clslogger(log, className, "btnrefresh_Click")
            Try
                ...
                rvComplaintsAnalysis.LocalReport.Refresh()
    ...
    Private Sub IAComplaintsAllFields_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreRender
        Using New clslogger(log, className, "IAComplaintsAllFields_PreRender")
            Try
                Dim fp As ucReportMenu = DirectCast(LoadControl("UserControls/ucReportMenu.ascx"),  _
                    ucReportMenu)
                fp.pageName = "IAComplaintsAllFields"
