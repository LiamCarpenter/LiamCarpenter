...
Partial Public Class IAContractsSummary
    Inherits clsNYS
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                lblBookingDetails.Text = "Contracts Summary - " & ddreport.SelectedItem.Text
            End If
            Me.Title = CStr(Session.Item("clientname")) & " Management Information by NYS Corporate"
        Catch ex As Exception
            handleexception(ex, "IAContractsSummary", Me.Page)
        End Try
    End Sub
    ...
    Protected Sub btnrefresh_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnrefresh.Click
        Using New clslogger(log, className, "btnrefresh_Click")
            Try
                ...
                rvContractsSummary.LocalReport.Refresh()
            Catch ex As Exception
                handleexception(ex, "IAContractsSummary", Me.Page)
            End Try
        End Using
    ...
    Private Sub IAContractsSummary_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreRender
        Using New clslogger(log, className, "IAContractsSummary_PreRender")
            Try
                Dim fp As ucReportMenu = DirectCast(LoadControl("UserControls/ucReportMenu.ascx"),  _
                    ucReportMenu)
                fp.pageName = "IAContractsSummary"
