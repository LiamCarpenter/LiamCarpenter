...
Public Class CSVReaderBooked
    ...
    Public Function Main(ByVal strDate As String) As Boolean
        ...
        Try
            ...
            '
            If IO.File.Exists(getConfig("downloadedfilesBooked") & strDate & ".csv") Then
                If Not importFile(getConfig("downloadedfilesBooked") & strDate & ".csv", _
    ...
    Public Function importFile(ByVal pstrFile As String,
        ...
        Try
            ...
            Dim Sorter As New Utility.Sorter(Of dataImportBooked)
