...
Public Class WebRetrieve
    ...
    Public Shared Function BookedAftData() As String
        Try
            ...
            If Not IO.File.Exists(getConfig("downloadedfilesBookedAft") & Format(Now, "dd-MM-yyyy") & ".csv") And _
                Not IO.File.Exists(getConfig("downloadedfilesBookedAftOK") & Format(Now, "dd-MM-yyyy") & ".csv") And _
                ...
                While bytesToRead > 0
                    ...
                    bytesToRead -= n
                End While
                Dim fstr As New FileStream(getConfig("downloadedfilesBookedAft") & Format(Now, "dd-MM-yyyy") & _
                                               ".csv", FileMode.OpenOrCreate, FileAccess.Write)
                fstr.Write(inBuf, 0, bytesRead)
                str.Close()
                fstr.Close()
