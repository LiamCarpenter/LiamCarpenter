<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="IAConfermaReportArrival.aspx.vb" Inherits="NYSInternalAdmin.IAConfermaReportArrival" %>
...
<body>
    ...
    <div>
     ...
     <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <asp:Label ID="lblBookingDetails" runat="server" 
             CssClass="nyslabelHeaderCentre" Style="z-index: 101; left: 4px; position: absolute;
                top: -2px; width: 1010px;" Text="Hotel Rooms by Arrival Date"></asp:Label>
     ...
     <asp:Image ID="imHover" runat="server" 
         ...
         <rsweb:ReportViewer ID="rvConfermaArrival" runat="server" BackColor="White" 
            ...
            LinkDisabledColor="LightGray" ToolBarItemBorderStyle="None" 
             ...
             <LocalReport ReportPath="Reports\repConfermaReportArrival.rdlc">
                 <DataSources>
                     <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" 
                         Name="dsConfermaReportArrival_confermaReportArrival" />
                 </DataSources>
             </LocalReport>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                ...
                TypeName="NYSInternalAdmin.dsConfermaReportArrivalTableAdapters.confermaReportArrivalTableAdapter">
                <SelectParameters>
