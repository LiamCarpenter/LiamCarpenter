<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="IAContractsAA.aspx.vb"
    Inherits="NYSInternalAdmin.IAContractsAA" %>
...
<body>
    ...
    <div>
        ...
        <asp:Label ID="lblBookingDetails" runat="server" CssClass="nyslabelHeaderCentre"
            ...
            Text="Contracts Awaiting Authorisation"></asp:Label>
        <asp:Panel ID="pnmain" runat="server" Style="left: 4px; position: absolute; z-index: 100;
            ...
            <rsweb:ReportViewer ID="rvContractsAA" runat="server" BackColor="White" CssClass="reportView"
                ...
                <LocalReport ReportPath="Reports\repContractsSummaryAA.rdlc">
                    <DataSources>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
                SelectMethod="GetData" TypeName="NYSInternalAdmin.dsContractsSummaryAATableAdapters.contractsSummaryAATableAdapter">
                <SelectParameters>
