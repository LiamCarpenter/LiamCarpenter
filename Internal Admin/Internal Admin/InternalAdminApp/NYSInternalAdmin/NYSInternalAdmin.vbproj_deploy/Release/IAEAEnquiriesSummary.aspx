<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="IAEAEnquiriesSummary.aspx.vb"
    Inherits="NYSInternalAdmin.IAEAEnquiriesSummary" %>
    ...
    <div>
        ...
        <asp:Panel ID="pnNav" runat="server" Style="left: 6px; position: absolute; z-index: 1000;
            ...
            <cc1:HoverMenuExtender ID="HoverMenuExtender1" runat="server" PopupControlID="pnNav"
                TargetControlID="imHover" OffsetY="-12" OffsetX="-11"></cc1:HoverMenuExtender>
            <asp:PlaceHolder ID="phMenu" runat="server"></asp:PlaceHolder>
        </asp:Panel>
        <asp:Label ID="lblEAenquiries" runat="server" CssClass="nyslabelHeaderCentre"
            Style="z-index: 101; left: 4px; position: absolute; top: -2px; width: 1010px;"
            Text="Environment Agency Enquires"></asp:Label>
        <asp:Panel ID="pnmain" runat="server" Style="left: 4px; position: absolute; z-index: 100;
            ...
            <asp:Panel ID="pndates" runat="server" CssClass="nyspanels" Style="left: 290px; position: absolute;
                ...
                <asp:Label ID="lblfrom" runat="server" CssClass="nyslabel" Style="z-index: 103; left: 13px;
                    position: absolute; top: 10px; width: 255px; right: 152px;" 
                    Text="Get Environment Agency enquiries:"></asp:Label>
                ...
                <asp:ImageButton ID="btnrefresh" runat="server" CssClass="btnclasshand" ImageUrl="~/images/refresh_out.gif"
                    Style="z-index: 109; left: 282px; position: absolute; top: 6px" TabIndex="3"
                    BorderStyle="None" />
            </asp:Panel>
            <asp:Image ID="imHover" runat="server" Style="z-index: 100; left: 9px; position: absolute;
                top: 10px;" ImageUrl="~/images/menu.gif" />
            <rsweb:ReportViewer ID="rvEAEnquiries" runat="server" BackColor="White" CssClass="reportView"
                DocumentMapWidth="100%" Font-Names="Verdana" Font-Size="8pt" Height="600px" InternalBorderStyle="None"
                ...
                Style="left: 4px; position: absolute; z-index: 100; top: 44px; height: 572px;
                width: 1002px;" ToolBarItemHoverBackColor="Silver" Width="995px" LinkDisabledColor="LightGray"
                ...
                <LocalReport ReportPath="Reports\repEAEnquiriesSummary.rdlc">
                    <DataSources>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                ...
                TypeName="NYSInternalAdmin.dsEAEnquiriesSummaryTableAdapters.EAEnquiriesSummaryTableAdapter">
                <SelectParameters>
