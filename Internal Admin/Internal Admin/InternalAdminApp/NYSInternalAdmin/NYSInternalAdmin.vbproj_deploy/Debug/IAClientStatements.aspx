<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="IAClientStatements.aspx.vb"
    Inherits="NYSInternalAdmin.IAClientStatements" %>
...
<body>
    ...
    <div>
        ...
        <asp:Label ID="lblBookingDetails" runat="server" CssClass="nyslabelHeaderCentre"
            ...
            Text="Client Statements"></asp:Label>
        <asp:Panel ID="pnmain" runat="server" Style="left: 4px; position: absolute; z-index: 100;
            ...
            <asp:Panel ID="pndates" runat="server" CssClass="nyspanels" Style="left: 101px; position: absolute;
                top: 4px; width: 903px; height: 37px; z-index: 10000;">
                <asp:Label ID="lblclients" runat="server" CssClass="nyslabel" Style="z-index: 103;
                    left: 13px; position: absolute; top: 8px; width: 95px; right: 720px; height: 16px;"
                    Text="Clients:"></asp:Label>
                <asp:DropDownList ID="ddClients" runat="server" Style="z-index: 99; left: 70px; position: absolute;
                    top: 8px; width: 654px;" CssClass="nysdropdown" AutoPostBack="true">
                </asp:DropDownList>
                <asp:ImageButton ID="btnrefresh" runat="server" BorderStyle="None" 
                    CssClass="btnclasshand" ImageUrl="~/images/run_over.gif" 
                    Style="z-index: 109; left: 733px; position: absolute; top: 5px; height: 24px;" 
                    TabIndex="4" />
               <asp:ImageButton ID="btnCSV" runat="server" BorderStyle="None" 
                    CssClass="btnclasshand" ImageUrl="~/images/csv_out.gif" 
                    Style="z-index: 109; left: 820px; position: absolute; top: 5px; height: 24px;" 
                    TabIndex="5" /> 
            ...
            <asp:Panel runat="server" ID="pnlDetails" Style="z-index: 113;
                    left: 101px; position: absolute; top: 73px; width: 828px;">
                <asp:Label ID="lblEmail" runat="server" Text="" style="display:block;clear:both;"></asp:Label>
                <asp:HyperLink ID="hlStatement" runat="server" style="display:block;clear:both;margin-top:20px;margin-bottom:20px;" CssClass="nyshyperlink" tabindex="9" 
                    Target="_blank" Visible="False">View statement</asp:HyperLink>
                <asp:Button ID="btnSendEmail" style="display:block;clear:both;" runat="server" Text="Send Email" Visible="false" />
            </asp:Panel>
