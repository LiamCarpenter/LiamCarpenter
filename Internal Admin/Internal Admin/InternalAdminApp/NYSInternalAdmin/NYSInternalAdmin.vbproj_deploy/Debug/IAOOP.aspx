<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="IAOOP.aspx.vb" Inherits="NYSInternalAdmin.IAOOP" %>
...
<body>
    ...
    <div>
     <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <asp:Label ID="lblBookingDetails" runat="server" 
             CssClass="nyslabelHeaderCentre" Style="z-index: 101; left: 4px; position: absolute;
                top: -2px; width: 1010px;" Text="Out Of Policy"></asp:Label>
     ...
     <asp:Image ID="imHover" runat="server" 
            ...
            Style="left: 4px; position: absolute; z-index:100; top: 44px; width: 995px;" 
            ...
            LinkDisabledColor="LightGray" ToolBarItemBorderStyle="None" 
             ...
             <LocalReport ReportPath="Reports\repOOP.rdlc">
                 <DataSources>
                     <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="dsOOP_oop_get" />
                 </DataSources>
             </LocalReport>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                ...
                TypeName="NYSInternalAdmin.CUBITDataSetTableAdapters.oop_getTableAdapter">
                <SelectParameters>
