<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="IAConfermaReport.aspx.vb" Inherits="NYSInternalAdmin.IAConfermaReport" %>
     ...
     <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <asp:Label ID="lblBookingDetails" runat="server" 
             CssClass="nyslabelHeaderCentre" Style="z-index: 101; left: 4px; position: absolute;
                top: -2px; width: 1010px;" Text="Hotel Rooms by Booked Date"></asp:Label>
     ...
     <asp:Image ID="imHover" runat="server" 
         ...
         <rsweb:ReportViewer ID="rvConferma" runat="server" BackColor="White" 
            ...
            LinkDisabledColor="LightGray" ToolBarItemBorderStyle="None" 
             ...
             <LocalReport ReportPath="Reports\repConfermaReport.rdlc">
                 <DataSources>
                     <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" 
                         Name="dsConfermaReport_confermaReport" />
                 </DataSources>
             </LocalReport>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                ...
                TypeName="NYSInternalAdmin.dsConfermaReportTableAdapters.confermaReportTableAdapter">
                <SelectParameters>
