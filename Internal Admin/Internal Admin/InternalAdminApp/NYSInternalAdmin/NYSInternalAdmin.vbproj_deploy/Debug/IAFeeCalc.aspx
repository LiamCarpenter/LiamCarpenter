<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="IAFeeCalc.aspx.vb" Inherits="NYSInternalAdmin.IAFeeCalc" %>
     ...
     <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <asp:Label ID="lblBookingDetails" runat="server" 
             CssClass="nyslabelHeaderCentre" Style="z-index: 101; left: 4px; position: absolute;
                top: -2px; width: 1010px;" Text="Print Fee Calc"></asp:Label>
       <asp:Panel ID="pnmain" runat="server" 
        ...
        <asp:Label ID="lblResult" runat="server" CssClass="nyslabel" Style="z-index: 103; left: 214px;
                position: absolute; top: 67px; width: 596px; right: 200px; height: 117px;" 
                   Text=""></asp:Label>
           ...
           <asp:Panel ID="pndates" runat="server" CssClass="nyspanels" 
               ...
               <asp:ImageButton ID="btnRun" runat="server" BorderStyle="None" 
                   CssClass="btnclasshand" ImageUrl="~/images/run_out.gif" 
