...
Partial Public Class Nhsi
    ...
    Private Shared Function makeNhsiFromRow( _
    ...
    Private Shared Function makeNhsiFromRowIndividual( _
            ByVal r As IDataReader _
        ) As Nhsi
        Return New Nhsi( _
    ...
    Public Shared Function listIndividual(ByVal pstartdate As String, ByVal penddate As String) As List(Of Nhsi)
        Using dbh As New SqlDatabaseHandle(getConnection)
            Dim ret As New List(Of Nhsi)()
            Using r As IDataReader = dbh.callSP("FeederFile_NHSIFirstRun", _
                                                "@startdate", pstartdate, _
                                                "@enddate", penddate)
                While r.Read()
                    ret.Add(makeNhsiFromRowIndividual(r))
                End While
            End Using
            Return ret
        End Using
    ...
    Public Shared Function getDetails(ByVal pInvno As String) As List(Of Nhsi)
        Using dbh As New SqlDatabaseHandle(getConnection)
            Dim ret As New List(Of Nhsi)()
            Using r As IDataReader = dbh.callSP("FeederFile_NHSIIndividual", _
                                                "@invno", pInvno)
                While r.Read()
                    ret.Add(makeNhsiFromRow(r))
                End While
            End Using
            Return ret
        End Using
    ...
    Public Shared Function list(ByVal pstartdate As String, ByVal penddate As String) As List(Of Nhsi)
        Using dbh As New SqlDatabaseHandle(getConnection)
            Dim ret As New List(Of Nhsi)()
            Using r As IDataReader = dbh.callSP("FeederFile_NHSI", _
                                                "@startdate", pstartdate, _
                                                "@enddate", penddate)
                While r.Read()
                    ret.Add(makeNhsiFromRow(r))
