<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="IAContractsNotReceived.aspx.vb" Inherits="NYSInternalAdmin.IAContractsNotReceived" %>
...
<body>
    ...
    <div>
        ...
        <asp:Label ID="lblBookingDetails" runat="server" CssClass="nyslabelHeaderCentre"
            ...
            Text="Contracts Not Received"></asp:Label>
        <asp:Panel ID="pnmain" runat="server" Style="left: 4px; position: absolute; z-index: 100;
            ...
            <asp:Panel ID="pndates" runat="server" CssClass="nyspanels" Style="left: 290px; position: absolute;
                top: 4px; width: 420px; height: 34px; z-index: 10000;">
                ...
                <asp:Label ID="lblfrom" runat="server" CssClass="nyslabel" Style="z-index: 103; left: 13px;
                    position: absolute; top: 10px; width: 114px; right: 293px;" Text="Enter dates from:"></asp:Label>
                ...
                <asp:TextBox ID="txtto" runat="server" CssClass="nystextbox" Style="z-index: 99;
                    left: 238px; position: absolute; top: 8px; width: 77px;" TabIndex="1"></asp:TextBox>
                <asp:TextBox ID="txtcompany" runat="server" CssClass="nystextbox" Style="z-index: 98;
                    left: 242px; position: absolute; top: 9px; width: 8px; height: 10px;" TabIndex="1"
                    Visible="False"></asp:TextBox>
                <asp:TextBox ID="txtbossname" runat="server" CssClass="nystextbox" Style="z-index: 98;
                    left: 241px; position: absolute; top: 9px; width: 9px; height: 15px;" TabIndex="1"
                    Visible="False"></asp:TextBox>
                ...
                <asp:ImageButton ID="btnrefresh" runat="server" CssClass="btnclasshand" ImageUrl="~/images/refresh_out.gif"
                    Style="z-index: 109; left: 325px; position: absolute; top: 6px" TabIndex="3"
                    BorderStyle="None" />
            </asp:Panel>
            <asp:Image ID="imHover" runat="server" Style="z-index: 100; left: 9px; position: absolute;
                top: 10px;" ImageUrl="~/images/menu.gif" />
            <rsweb:ReportViewer ID="rvContractsNotReceived" runat="server" BackColor="White" CssClass="reportView"
                ...
                <LocalReport ReportPath="Reports\repContractsNotReceived.rdlc">
                    <DataSources>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                ...
                TypeName="NYSInternalAdmin.dsContractsNotRecievedTableAdapters.ContractsNotReceived_ConfirmedTableAdapter">
                <SelectParameters>
