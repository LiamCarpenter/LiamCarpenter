<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="IAOtherTTAllClients.aspx.vb"
    Inherits="NYSInternalAdmin.IAOtherTTAllClients" %>
...
<body>
    ...
    <div>
        ...
        <asp:Label ID="lblBookingDetails" runat="server" CssClass="nyslabelHeaderCentre"
            Style="z-index: 101; left: 3px; position: absolute; top: -2px; width: 1010px;"
            Text="Ancillaries Report - Car/Coach/Ferry/International Rail"></asp:Label>
        <asp:Panel ID="pnmain" runat="server" Style="left: 4px; position: absolute; z-index: 100;
            ...
            <asp:Panel ID="pndates" runat="server" CssClass="nyspanelsSM" Style="left: 114px;
                position: absolute; top: 4px; width: 782px; height: 40px; z-index: 10000;">
                <asp:Label ID="lblto" runat="server" CssClass="nyslabel" Style="z-index: 103; position: absolute;
                    top: 11px; width: 18px; right: 508px; height: 14px;" Text="To:"></asp:Label>
                ...
                <asp:TextBox ID="txtto" runat="server" CssClass="nystextbox" Style="z-index: 99;
                    left: 287px; position: absolute; top: 8px; width: 77px;" TabIndex="2"></asp:TextBox>
                <asp:ImageButton ID="btnrefresh" runat="server" CssClass="btnclasshand" ImageUrl="~/images/refresh_out.gif"
                    Style="z-index: 109; left: 693px; position: absolute; top: 11px" TabIndex="4"
                    BorderStyle="None" />
            </asp:Panel>
            <asp:Image ID="imHover" runat="server" Style="z-index: 100; left: 9px; position: absolute;
                top: 10px;" ImageUrl="~/images/menu.gif" />
                
                  <rsweb:reportviewer id="rvOtherTT" runat="server" backcolor="White" cssclass="reportView"
                ...
                reportpath="Reports\repAirTTAllClients_FromBOSS.rdlc"></LocalReport></rsweb:reportviewer>
      ...
      <%--      <rsweb:ReportViewer ID="rvOtherTT" runat="server" backcolor="White" cssclass="reportView"
                ...
                showzoomcontrol="False" style="left: 5px; position: absolute; z-index: 100; top: 46px;"
                ...
                waitmessagefont-size="14pt"><localreport 
                reportpath="Reports\repOtherTTAllClients.rdlc"></localreport></rsweb:ReportViewer>
                  </asp:Panel>--%>
