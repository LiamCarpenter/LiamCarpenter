<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="IAEnquiryCancellationFormCheck.aspx.vb" Inherits="NYSInternalAdmin.IAEnquiryCancellationFormCheck" %>
...
<body>
    ...
    <div>
      ...
      <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <asp:Label ID="lblBookingDetails" runat="server" 
             CssClass="nyslabelHeaderCentre" Style="z-index: 101; left: 4px; position: absolute;
                top: -2px; width: 1010px;" Text="Cancellation Form Check"></asp:Label>       
     ...
     <asp:Image ID="imHover" runat="server" 
         ...
         <rsweb:ReportViewer ID="rvCancellationCheck" runat="server" BackColor="White" 
            ...
            Style="left: 4px; position: absolute; z-index:100; top: 48px;" 
            ...
            LinkDisabledColor="LightGray" ToolBarItemBorderStyle="None" 
             ...
             <LocalReport ReportPath="Reports\repEnquiryCancellationFormCheck.rdlc">
                 <DataSources>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                ...
                TypeName="NYSInternalAdmin.dsEnquiryCancellationFormCheckTableAdapters.EnquiryCancellationFormCheckTableAdapter">
                <SelectParameters>
