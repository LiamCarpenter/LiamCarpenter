<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="IAComplaintsBookings.aspx.vb" Inherits="NYSInternalAdmin.IAComplaintsBookings" %>
     ...
     <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <asp:Label ID="lblBookingDetails" runat="server" 
             CssClass="nyslabelHeaderCentre" Style="z-index: 101; left: 4px; position: absolute;
                top: -2px; width: 1010px;" Text="Cancelled Bookings"></asp:Label>
        ...
        <asp:Image ID="imHover" runat="server" 
         ...
         <rsweb:ReportViewer ID="rvConferenceCancelled" runat="server" BackColor="White" 
            ...
            LinkDisabledColor="LightGray" ToolBarItemBorderStyle="None" Height="600px" 
             ...
             <LocalReport ReportPath="Reports\repCompBookings.rdlc">
                 <DataSources>
                     <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" 
                         Name="dsCompBookings_COMP_Bookings" />
                 </DataSources>
             </LocalReport>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                ...
                TypeName="NYSInternalAdmin.dsCompBookingsTableAdapters.COMP_BookingsTableAdapter">
                <SelectParameters>
