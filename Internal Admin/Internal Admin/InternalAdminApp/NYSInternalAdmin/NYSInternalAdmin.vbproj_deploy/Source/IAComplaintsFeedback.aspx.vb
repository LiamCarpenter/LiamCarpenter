...
Partial Public Class IAComplaintsFeedback
    Inherits clsNYS
        ...
        Using New clslogger(log, className, "Page_Load")
            Try
                If Not IsPostBack Then
                    ...
                    lblBookingDetails.Text = labelText("Feedback Analysis", dtstart.Day, dtstart.Month, dtstart.Year, dtend.Day, dtend.Month, dtend.Year)

                    'Dim dsSummary = New ReportDataSource("dsConfCancelledSummary_conferenceCancelledSummary", ObjectDataSource1.SelectMethod.("Getdata"). dsConfCancelledSummaryTableAdapters.conferenceCancelledSummaryTableAdapter.
                    '        clsEvolviData.conferenceBookingSummaryByMonth(CInt(Session.Item("client")), Format(dtYearStart, "dd/MM/yyyy"), _
                    '                                                      Format(dtReportEnd, "dd/MM/yyyy"), True))
                End If
                Me.Title = "Management Information by NYS Corporate"
            Catch ex As Exception
                handleexception(ex, "IAComplaintsFeedback", Me.Page)
            End Try
        End Using
    End Sub
    ...
    Protected Sub btnrefresh_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnrefresh.Click
        Using New clslogger(log, className, "btnrefresh_Click")
            Try
                ...
                rvFeedbackAnalysis.LocalReport.Refresh()
    ...
    Private Sub IAComplaintsFeedback_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreRender
        Using New clslogger(log, className, "IAComplaintsFeedback_PreRender")
            Try
                Dim fp As ucReportMenu = DirectCast(LoadControl("UserControls/ucReportMenu.ascx"),  _
                    ucReportMenu)
                fp.pageName = "IAComplaintsFeedback"
