<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="IAEvolviProductivity.aspx.vb" Inherits="NYSInternalAdmin.IAEvolviProductivity" %>
     ...
     <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <asp:Label ID="lblBookingDetails" runat="server" 
             CssClass="nyslabelHeaderCentre" Style="z-index: 101; left: 4px; position: absolute;
                top: -2px; width: 1010px;" Text="Evolvi Productivity"></asp:Label>
        ...
        <asp:TextBox ID="txtcompany" runat="server" CssClass="nystextbox" Style="z-index: 98; left: 241px; position: absolute;
                top: 10px; width: 10px; height: 13px;" TabIndex="1" Visible="False"></asp:TextBox>
        <asp:TextBox ID="txtbossname" runat="server" CssClass="nystextbox" Style="z-index: 98; left: 241px; position: absolute;
                top: 10px; width: 9px; height: 9px;" TabIndex="1" Visible="False"></asp:TextBox>
        ...
        <asp:Image ID="imHover" runat="server" 
         ...
         <rsweb:ReportViewer ID="rvEvolviProductivity" runat="server" BackColor="White" 
            ...
            LinkDisabledColor="LightGray" ToolBarItemBorderStyle="None" Height="600px" 
                Width="995px" LinkActiveColor="Blue" LinkActiveHoverColor="DeepPink" 
                ShowBackButton="False"><LocalReport ReportPath="Reports\repEvolviProductivity.rdlc"><DataSources><rsweb:ReportDataSource DataSourceId="ObjectDataSource1" 
                         Name="dsEvolviProductivity_Evolvi_productivity" /></DataSources></LocalReport></rsweb:ReportViewer>
        
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" 
                
                TypeName="NYSInternalAdmin.dsEvolviProductivityTableAdapters.Evolvi_productivityTableAdapter">
                <SelectParameters>
