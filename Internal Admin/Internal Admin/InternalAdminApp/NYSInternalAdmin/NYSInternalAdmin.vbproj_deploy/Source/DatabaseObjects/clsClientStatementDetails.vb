...
Public Class clsClientStatementDetails
    ...
    'R2.21.1 SA 
    Private mSendDailyReminders As Boolean
    Private mSendReminderToBooker As Boolean
    Private mShowBookerName As Boolean
    ...
    'R2.21.1 SA 
    Public Property SendDailyReminders() As Boolean
        Get
            Return mSendDailyReminders
        End Get
        Set(ByVal value As Boolean)
            mSendDailyReminders = value
        End Set
    End Property

    'R2.21.1 SA 
    Public Property SendReminderToBooker() As String
        Get
            Return mSendReminderToBooker
        End Get
        Set(ByVal value As String)
            mSendReminderToBooker = value
        End Set
    End Property

    'R2.21.1 SA 
    Public Property ShowBookerName() As String
        Get
            Return mShowBookerName
        End Get
        Set(ByVal value As String)
            mShowBookerName = value
        End Set
    End Property
            ...
            Using r As IDataReader = dbh.callSP("ClientStatementDetails_getDetails", _
                ...
                While r.Read()
                    With details
                        ...
                        'R2.21.1 SA 
                        .SendDailyReminders = clsNYS.notBoolean(r.Item("csd_SendDailyReminder"))
                        .SendReminderToBooker = clsNYS.notBoolean(r.Item("csd_SendReminderToBooker"))
                        .ShowBookerName = clsNYS.notBoolean(r.Item("csd_ShowBookerName"))
                    End With
                End While
            End Using
            Return details
    ...
    'R2.21.1 SA - added pSendDailyReminder, pSendReminderToBooker, pAddBookerName
    Public Shared Function update(ByVal pID As Integer, _
                                 ...
                                 ByVal pSendDailyReminder As Boolean, _
                                 ByVal pSendReminderToBooker As Boolean, _
                                 ByVal pShowBookerName As Boolean) As Boolean
        Using dbh As New SqlDatabaseHandle(getConfig("ConnectionString"))
            Dim blnRet As Boolean = CBool(dbh.callSPSingleValue("ClientStatementDetails_update", _
                                                               ...
                                                               "@csd_Reference2", pReference2, _
                                                               "@csd_SendDailyReminder", pSendDailyReminder, _
                                                               "@csd_SendReminderToBooker", pSendReminderToBooker, _
                                                               "@csd_ShowBookerName", pShowBookerName))
            Return blnRet
        End Using
    End Function
