<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="IAComplaintsAllFields.aspx.vb" Inherits="NYSInternalAdmin.IAComplaintsAllFields" %>
     ...
     <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <asp:Label ID="lblBookingDetails" runat="server" 
             CssClass="nyslabelHeaderCentre" Style="z-index: 101; left: 4px; position: absolute;
                top: -2px; width: 1010px;" Text="Bookings Analysis"></asp:Label>
        ...
        <asp:Image ID="imHover" runat="server" 
         ...
         <rsweb:ReportViewer ID="rvComplaintsAnalysis" runat="server" BackColor="White" 
            ...
            LinkDisabledColor="LightGray" ToolBarItemBorderStyle="None" Height="600px" 
             ...
             <LocalReport ReportPath="Reports\repCompAllFields.rdlc">
                 <DataSources>
                     <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" 
                         Name="dsCompAllFields_COMP_Allfields" />
                 </DataSources>
             </LocalReport>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                ...
                TypeName="NYSInternalAdmin.dsCompAllFieldsTableAdapters.COMP_AllfieldsTableAdapter">
                <SelectParameters>
