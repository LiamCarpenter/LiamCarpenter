...
Partial Public Class IAContractsSummaryByUser
    Inherits clsNYS
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                End If
                lblBookingDetails.Text = "Contracts Summary By User - " & ddreport.SelectedItem.Text
            End If
            Me.Title = CStr(Session.Item("clientname")) & " Management Information by NYS Corporate"
        Catch ex As Exception
            handleexception(ex, "IAContractsSummaryByUser", Me.Page)
        End Try
    End Sub
    ...
    Protected Sub btnlogout_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnlogout.Click
        If CStr(Session.Item("LoginType")) = "CLIENT" Then
            Response.Redirect("IALogonClient.aspx")
        Else
    ...
    Protected Sub btnrefresh_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnrefresh.Click
        Using New clslogger(log, className, "btnrefresh_Click")
            Try
                ...
                lblBookingDetails.Text = "Contracts Summary By User - " & ddreport.SelectedItem.Text
                rvContractsSummaryByUser.LocalReport.Refresh()
                rvContractsSummaryByUserChart.LocalReport.Refresh()
            Catch ex As Exception
                handleexception(ex, "IAContractsSummaryByUser", Me.Page)
            End Try
        End Using
    ...
    Private Sub IAContractsSummaryByUser_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreRender
        Using New clslogger(log, className, "IAContractsSummaryByUser_PreRender")
            Try
                Dim fp As ucReportMenu = DirectCast(LoadControl("UserControls/ucReportMenu.ascx"),  _
                    ucReportMenu)
                fp.pageName = "IAContractsSummaryByUser"
