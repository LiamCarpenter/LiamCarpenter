...
(function() {
    ...
    window.CKEDITOR || (window.CKEDITOR = function() {
        ...
        if (b) {
            var c = f.getUrl;
            f.getUrl = function(a) { return b.call(f, a) || c.call(f, a) };
        }
        return f;
    }());
    CKEDITOR.event || (CKEDITOR.event = function() {}, CKEDITOR.event.implementOn = function(a) {
        ...
        return{
            ...
            on: function(b, e, d, f, k) {
                function j(a, m, y, s) {
                    a = { name: b, sender: this, editor: a, data: m, listenerData: f, stop: y, cancel: s, removeListener: g };
                    return e.call(d, a) === false ? false : a.data;
                }

                function g() { y.removeListener(b, e) }
            ...
            fire: function() {
                var a = 0, e = function() { a = 1 }, d = 0, b = function() { d = 1 };
        ...
        (function() {
            CKEDITOR.domReady(function() {
                ...
                if (a) {
                    ...
                    a && a._load ? a() : f && setTimeout(function() { CKEDITOR.loadFullCore && CKEDITOR.loadFullCore() }, f * 1E3);
                }
            });
        })();
    ...
    (function() {
        ...
        CKEDITOR.tools = {
            ...
            capitalize: function(a, e) { return a.charAt(0).toUpperCase() + (e ? a.slice(1) : a.slice(1).toLowerCase()) },
            extend: function(a) {
            ...
            cssStyleToDomStyle: function() {
                ...
                return function(a) { return a == "float" ? e : a.replace(/-./g, function(a) { return a.substr(1).toUpperCase() }) };
            }(),
            ...
            htmlEncode: function(a) { return("" + a).replace(b, "&amp;").replace(c, "&gt;").replace(e, "&lt;") },
            htmlDecode: function(a) { return a.replace(h, "&").replace(k, ">").replace(j, "<") },
            htmlEncodeAttr: function(a) { return a.replace(d, "&quot;").replace(e, "&lt;").replace(c, "&gt;") },
            htmlDecodeAttr: function(a) { return a.replace(g, '"').replace(j, "<").replace(k, ">") },
            ...
            setTimeout: function(a, e, d, b, c) {
                c || (c = window);
                d || (d = c);
                return c.setTimeout(function() { b ? a.apply(d, [].concat(b)) : a.apply(d) }, e || 0);
            },
            trim: function() {
                var a = /(?:^[ \t\n\r]+)|(?:[ \t\n\r]+$)/g;
            ...
            createClass: function(a) {
                ...
                !e && (e = function() { d && this.base.apply(this, arguments) });
                if (b)
                    var f = e,
                        e = function() {
            ...
            addFunction: function(e, d) { return a.push(function() { return e.apply(d || this, arguments) }) - 1 },
            ...
            defer: function(a) {
                return function() {
                    ...
                    window.setTimeout(function() { a.apply(d, e) }, 0);
                };
            },
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
        ...
        getPosition: function(a) {
            ...
            for (var f = this.getAddress(),
                a = a.getAddress(),
                b = Math.min(f.length, a.length),
                c = 0; c <= b - 1; c++)
                if (f[c] != a[c]) {
        ...
        move: function(a, f) { a.append(this.remove(), f) },
        remove: function(a) {
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.window.prototype, {
        ...
        getViewPaneSize: function() {
            ...
            return{ width: (f ? a.documentElement.clientWidth : a.body.clientWidth) || 0, height: (f ? a.documentElement.clientHeight : a.body.clientHeight) || 0 };
        },
    ...
    CKEDITOR.dom.element.clearAllMarkers = function(a) { for (var f in a)CKEDITOR.dom.element.clearMarkers(a, a[f], 1) };
    ...
    (function() {
        ...
        function f(a, d) { return"#" + a.$.id + " " + d.split(/,\s*/).join(", #" + a.$.id + " ") }
            ...
            removeStyle: function(a) {
                ...
                if (!b.removeProperty && (a == "border" || a == "margin" || a == "padding")) {
                    ...
                    for (var b = [], j = 0; j < c.length; j++)
                        if (f)for (var g = 0; g < f.length; g++)b.push([a, c[j], f[g]].join("-"));
    ...
    (function() {
        function a(a, b) {
            ...
            if (a && !this._.guardRTL) {
                ...
                this._.guardRTL = function(a, b) { return(!b || !g.equals(a)) && (!C || !a.equals(C)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root)) };
            }
            var j = a ? this._.guardRTL : this._.guardLTR;
            h = o ? function(a, b) { return j(a, b) === false ? false : o(a, b) } : j;
        ...
        CKEDITOR.dom.walker = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                lastForward: function() { return f.call(this) },
                lastBackward: function() { return f.call(this, 1) },
                reset: function() {
                    delete this.current;
                    this._ = {};
                }
        ...
        CKEDITOR.dom.range.prototype =
        {
            ...
            createBookmark2: function() {
                ...
                return function(b) {
                    ...
                    return{ start: d.container.getAddress(b), end: c ? null : e.container.getAddress(b), startOffset: d.offset, endOffset: e.offset, normalized: b, collapsed: c, is2: true };
                };
            }(),
            ...
            enlarge: function(a, b) {
                ...
                case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                    ...
                    if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
                        ...
                        o.evaluator = function(a) { return!x(a) && !E(a) };
                        if ((o = o.previous()) &&
        ...
        a.prototype = {
            getNextParagraph: function(a) {
                ...
                for (this._.nextNode = null; i;) {
                    ...
                    if (o)
                        i.type == CKEDITOR.NODE_TEXT && e.test(i.getText()) &&
                        (o = 0);
                    else {
                        var p = i.getName();
                ...
                if (!this._.nextNode)
                    this._.nextNode = s || f.equals(t) || !t ? null : this._getNextSourceNode(f,
                        1, t);
                return f;
            },
            _getNextSourceNode: function(a, b, c) {
                function e(a) { return!(a.equals(c) || a.equals(f)) }
    ...
    CKEDITOR.command = function(a, f) {
        ...
        this.refresh = function(a, b) {
            ...
            this.modes && !this.modes[a.mode] &&
                this.disable();
            return this.fire("refresh", { editor: a, path: b }) === false ? true : f.refresh && f.refresh.apply(this, arguments) !== false;
        };
        var b;
    ...
    (function() {
        ...
        function w(a, b, d, e) {
            ...
            if (e.doFilter) {
                a: {
                    ...
                    n = e.skipRequired;
                    v = { valid: false, validAttributes: {}, validClasses: {}, validStyles: {}, allAttributes: false, allClasses: false, allStyles: false, hadInvalidAttribute: false, hadInvalidClass: false, hadInvalidStyle: false };
                    var q, z;
                    if (!a && !r)a = null;
                    else {
                        s(b);
        ...
        function o(a) { return a.type == CKEDITOR.NODE_ELEMENT && (a.name == "br" || L.$block[a.name]) }
                    ...
                    if (e) {
                        ...
                        for (var f = e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || e.name == "body", l, r, p = d.length; p > 0;) {
                            ...
                            if (f && (i.type == CKEDITOR.NODE_TEXT || i.type == CKEDITOR.NODE_ELEMENT && L.$inline[i.name])) {
                                ...
                                r = L[e.name] || L.span;
                                i.insertAfter(a);
                                e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT && (i.type == CKEDITOR.NODE_ELEMENT && !r[i.name]) && c.push({ check: "el-up", el: i });
                            }
                        }
                        a.remove();
                    }
        ...
        function P(a) { return function(b) { return r(b, a) } }
        ...
        CKEDITOR.filter.prototype = {
            ...
            applyTo: function(a, b, c, d) {
                ...
                var e = this, f = [], p = this.editor && this.editor.config.protectedSource, r, x = false, h = { doFilter: !c, doTransform: true, doCallbacks: true, toHtml: b };
                a.forEach(function(a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
                ...
                for (var n,
                    ...
                    q; c = f.pop();)c.type == CKEDITOR.NODE_ELEMENT ? l(c, d, a) : c.remove();
                for (; n = a.pop();) {
                    c = n.el;
                    if (c.parent) {
            ...
            check: function(a, b, c) {
                ...
                if (typeof a == "string") {
                    ...
                    e = { name: d.element, attributes: i, classes: i["class"] ? i["class"].split(/\s+/) : [], styles: e, children: [] };
                }
    ...
    CKEDITOR.scriptLoader = function() {
        ...
        return{
            load: function(b, c, e, d) {
                ...
                h && (b = [b]);
                e || (e = CKEDITOR);
                var k = b.length, j = [], g = [], m = function(a) { c && (h ? c.call(e, a) : c.call(e, j, g)) };
                if (k === 0)m(true);
                else {
                    var y = function(a, b) {
                            (b ? j : g).push(a);
                                ...
                                if (!(d.length >
                                    ...
                                    if (c)
                                        if (CKEDITOR.env.ie && CKEDITOR.env.version < 11)
                                            ...
                                            e.$.onload = function() { setTimeout(function() { s(b, true) }, 0) };
                                            e.$.onerror = function() { s(b, false) };
                                        }
    ...
    CKEDITOR.ui.prototype = {
        add: function(a, f, b) {
            ...
            var c = this.items[a] = { type: f, command: b.command || null, args: Array.prototype.slice.call(arguments, 2) };
    ...
    (function() {
        ...
        function k(a) { CKEDITOR.skin.loadPart("editor", function() { j(a) }) }
        ...
        function m(a) {
            ...
            CKEDITOR.plugins.load(c.split(","), function(c) {
                ...
                for (var i in c) {
                    ...
                    if (A && (v = A.match(l)))for (; A = v.pop();)CKEDITOR.tools.setTimeout(function(a, b) { throw Error('Plugin "' + a.replace(",", "") + '" cannot be removed from the plugins list, because it\'s required by "' + b + '" plugin.'); }, 0, null, [A, i]);
                    if (g && !a.lang[i]) {
                        g.split && (g = g.split(","));
    ...
    (function() {
        var a = /([\w\-:.]+)(?:(?:\s*=\s*(?:(?:"([^"]*)")|(?:'([^']*)')|([^\s>]+)))|(?=\s|$))/g, f = { checked: 1, compact: 1, declare: 1, defer: 1, disabled: 1, ismap: 1, multiple: 1, nohref: 1, noresize: 1, noshade: 1, nowrap: 1, readonly: 1, selected: 1 };
    ...
    CKEDITOR.htmlParser.basicWriter = CKEDITOR.tools.createClass({
        ...
        proto: {
            ...
            openTagClose: function(a, f) { f ? this._.output.push(" />") : this._.output.push(">") },
    ...
    (function() {
        ...
        CKEDITOR.htmlParser.node.prototype = {
            ...
            getAscendant: function(a) {
                var f = typeof a == "function" ? a : typeof a == "string" ? function(b) { return b.name == a } : function(b) { return b.name in a }, b = this.parent;
                for (; b &&
    ...
    (function() {
        ...
        var f = CKEDITOR.tools.extend({ table: 1, ul: 1, ol: 1, dl: 1 }, CKEDITOR.dtd.table, CKEDITOR.dtd.ul, CKEDITOR.dtd.ol, CKEDITOR.dtd.dl), b = { ol: 1, ul: 1 }, c = CKEDITOR.tools.extend({}, { html: 1 }, CKEDITOR.dtd.html, CKEDITOR.dtd.body, CKEDITOR.dtd.head, { style: 1, script: 1 }), e = { ul: "li", ol: "li", dl: "dd", table: "tbody", tbody: "tr", thead: "tr", tfoot: "tr", tr: "td" };
        CKEDITOR.htmlParser.fragment.fromHtml =
            function(d, h, k) {
                ...
                function g() { for (; A.length;)y(A.shift(), u) }
                ...
                function w(a, b) { return a in CKEDITOR.dtd.$listItem || a in CKEDITOR.dtd.$tableContent ? a == b || a == "dt" && b == "dd" || a == "dd" && b == "dt" : false }
                ...
                q.onCDATA = function(a) { u.add(new CKEDITOR.htmlParser.cdata(a)) };
    ...
    (function() {
        ...
        CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                onText: function(a, c, e) { return this.textRules.exec(a, c, e) },
                onComment: function(a, c, e) { return this.commentRules.exec(a, c, e) },
        ...
        a.prototype = {
            add: function(a, c, e) { this.rules.splice(this.findIndex(c), 0, { value: a, priority: c, options: e }) },
            addMany: function(a,
                c, e) {
                for (var d = [this.findIndex(c), 0], f = 0, k = a.length; f < k; f++)d.push({ value: a[f], priority: c, options: e });
    ...
    (function() {
        function a(a, f) {
            function p(a) { return a || CKEDITOR.env.needsNbspFiller ? new CKEDITOR.htmlParser.text(" ") : new CKEDITOR.htmlParser.element("br", { "data-cke-bogus": 1 }) }
        ...
        function f(a, b) { return a != CKEDITOR.ENTER_BR && b !== false ? a == CKEDITOR.ENTER_DIV ? "div" : "p" : false }
        ...
        function d(a) { return a && (a.type == CKEDITOR.NODE_ELEMENT && a.name in l || a.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT) }
        ...
        function g(a) { return a.replace(C, function(a, b, c) { return"<" + b + c.replace(L, function(a, b) { return F.test(b) && c.indexOf("data-cke-saved-" + b) == -1 ? " data-cke-saved-" + a + " data-cke-" + CKEDITOR.rnd + "-" + a : a }) + ">" }) }
        ...
        function y(a) { return a.replace(v, function(a, b) { return decodeURIComponent(b) }) }
        ...
        function w(a) { return a.replace(/<\!--\{cke_protected\}\{C\}([\s\S]+?)--\>/g, function(a, b) { return decodeURIComponent(b) }) }
        ...
        function t(a, b) {
            ...
            return a = a.replace(/<(title|iframe|textarea)([^>]*)>([\s\S]*?)<\/\1>/g, function(a, c, d, e) { return"<" + c + d + ">" + q(w(e), b) + "</" + c + ">" });
        }
        ...
        CKEDITOR.htmlDataProcessor = function(b) {
            ...
            b.on("toHtml", function(a) { a.data.dataValue.filterChildren(e.dataFilter, true) }, null, null, 10);
            b.on("toHtml", function(a) {
            ...
            b.on("toDataFormat", function(a) { a.data.dataValue.filterChildren(e.htmlFilter, true) }, null, null, 10);
        ...
        CKEDITOR.htmlDataProcessor.prototype = {
            toHtml: function(a, b, c, d) {
                ...
                return e.fire("toHtml", { dataValue: a, context: f, fixForBody: c, dontFilter: d, filter: i || e.filter, enterMode: l || e.enterMode }).dataValue;
            },
        ...
        if (CKEDITOR.env.ie)P.attributes.style = function(a) { return a.replace(/(^|;)([^\:]+)/g, function(a) { return a.toLowerCase() }) };
    ...
    (function() {
        ...
        CKEDITOR.template = function(d) {
            if (a[d])this.output = a[d];
                ...
                var h = d.replace(b, "\\$1").replace(c, "\\n").replace(e, "\\r").replace(f, function(a, b) { return"',data['" + b + "']==undefined?'{" + b + "}':data['" + b + "'],'" });
    ...
    (function() {
        var a = [];
        CKEDITOR.addCss = function(f) { a.push(f) };
    ...
    (function() {
        ...
        function b(a) {
            var b = a.name,
                ...
                b = CKEDITOR.dom.element.createFromHtml(g.output({ id: a.id, name: b, langDir: a.lang.dir, langCode: a.langCode, voiceLabel: a.title, topHtml: k ? '<span id="' + a.ui.spaceId("top") + '" class="cke_top cke_reset_all" role="presentation" style="height:auto">' + k + "</span>" : "", contentId: a.ui.spaceId("contents"), bottomHtml: j ? '<span id="' + a.ui.spaceId("bottom") + '" class="cke_bottom cke_reset_all" role="presentation">' + j + "</span>" : "", outerEl: CKEDITOR.env.ie ? "span" : "div" }));
        ...
        CKEDITOR.editor.prototype.resize = function(a, b, d, f) {
            var k = this.container, j = this.ui.space("contents"), g = CKEDITOR.env.webkit && this.document && this.document.getWindow().$.frameElement, f = f ? this.container.getFirst(function(a) { return a.type == CKEDITOR.NODE_ELEMENT && a.hasClass("cke_inner") }) : k;
    ...
    (function() {
        function a(a) {
            ...
            if (h(b, d.block, e) && p.collapsed && !p.getCommonAncestor().isReadOnly()) {
                ...
                e.guard = function(a) { return!c(a) || a.type == CKEDITOR.NODE_COMMENT || a.isReadOnly() };
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                insertElementIntoRange: function(a, b) {
                    ...
                    b.deleteContents(1);
                    b.startContainer.type == CKEDITOR.NODE_ELEMENT && b.startContainer.is({ tr: 1, table: 1, tbody: 1, thead: 1, tfoot: 1 }) && t(b);
                    var r, n;
                    if (f)
                        for (; (r = b.getCommonAncestor(0, 1)) && (n = CKEDITOR.dtd[r.getName()]) && (!n || !n[e]);)
                            if (r.getName() in
                ...
                setup: function() {
                    ...
                    this.attachListener(a, "beforeGetData", function() {
                        var b = this.getData();
                        this.is("textarea") || a.config.ignoreEmptyParagraph !== false && (b = b.replace(y, function(a, b) { return b }));
                        a.setData(b, null, 1);
                    }, this);
                    this.attachListener(a,
                        "getSnapshot", function(a) { a.data = this.getData(1) }, this);
        ...
        var q = function() {
                    ...
                    for (var g = r[g.getName()], n = 0, j = c.getChildren(), m = j.count(), o = -1, C = -1, k = 0, q = e.contains(r.$list); n < m; ++n) {
                        ...
                        if (a(e)) {
                            ...
                            if (q && l in CKEDITOR.dtd.$list)h = h.concat(b(e, d));
                                ...
                                o == -1 && !p && (o = n);
                                p || (C = n);
                                h.push({ isElement: 1, isLineBreak: k, isBlock: e.isBlockBoundary(), hasBlockSibling: f, node: e, name: l, allowed: p });
                                f = k = 0;
                            }
                ...
                function e(b) { return b && a(b) && (b.is(r.$removeEmpty) || b.is("a") && !b.isBlockBoundary()) }
                ...
                var r = CKEDITOR.dtd, g = { p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, ul: 1, ol: 1, li: 1, pre: 1, dl: 1, blockquote: 1 }, m = { p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1 }, C = CKEDITOR.tools.extend({}, r.$inline);
                delete C.br;
                return function(g, n, k) {
                    ...
                    if (!v.checkReadOnly()) {
                        var z = (new CKEDITOR.dom.elementPath(v.startContainer, v.root)).blockLimit || v.root, n = { type: n, dontFilter: G, editable: g, editor: q, range: v, blockLimit: z, mergeCandidates: [], zombies: [] }, q = n.range, G = n.mergeCandidates, B, x, E, s;
                        ...
                        if (B = k) {
                            ...
                            k = n.editor.dataProcessor.toHtml(k, { context: null, fixForBody: false, dontFilter: n.dontFilter, filter: n.editor.activeFilter, enterMode: n.editor.activeEnterMode });
                            ...
                            if ((y = B.startPath().block) && !(y.getChildCount() == 1 && y.getBogus()))
                                a: {
                                    var t;
    ...
    (function() {
        ...
        function c(a) { return t(a) || a.type == CKEDITOR.NODE_ELEMENT && !a.is(CKEDITOR.dtd.$empty) ? true : false }
        ...
        function j(a) { return[{ node: a.anchorNode, offset: a.anchorOffset }, { node: a.focusNode, offset: a.focusOffset }] }
        ...
        var w,
            q,
            t = CKEDITOR.dom.walker.invisible(1),
            i = function() {
                function a(b) {
                    return function(a) {
                    ...
                    if (this.isLocked) {
                        ...
                        if (g)this.fake(g);
                            ...
                            if (A) {
                                ...
                                if ((c = g.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && c.getName() in o && (!c.is("a") || !c.getText()))
                                    try {
...
*/
    ...
    CKEDITOR.plugins.add("dialogui", {
        onLoad: function() {
            ...
            CKEDITOR.dialog.addUIElement("StaffPassword",
                r);
    ...
    (function() {
        ...
        function j(a) {
            ...
            f ? f.show() : (g = [
                    '<div tabIndex="-1" style="position: ', CKEDITOR.env.ie6Compat ? "absolute" : "fixed", "; z-index: ", g, "; top: 0px; left: 0px; ", !CKEDITOR.env.ie6Compat ?
    ...
    (function() {
        ...
        CKEDITOR.ui.button.prototype = {
            render: function(a, b) {
                ...
                this._.editor = a;
                var d = { id: k, button: this, editor: a, focus: function() { CKEDITOR.document.getById(k).focus() }, execute: function() { this.button.click(a) }, attach: function(a) { this.button.attach(a) } },
                    q = CKEDITOR.tools.addFunction(function(a) { if (d.onkey)return a = new CKEDITOR.dom.event(a), !1 !== d.onkey(d, a.getKeystroke()) }),
                ...
                if (this.modes) {
                    var i = {};
                    a.on("beforeModeUnload", function() { a.mode && this._.state != CKEDITOR.TRISTATE_DISABLED && (i[a.mode] = this._.state) }, this);
                    a.on("activeFilterChange", c, this);
                    a.on("mode", c, this);
                    !this.readOnly && a.on("readOnly", c, this);
                } else if (g && (g = a.getCommand(g)))
                    g.on("state", function() { this.setState(g.state) }, this),
                ...
                f = { id: k, name: n, iconName: h, label: this.label, cls: this.className || "", state: f, ariaDisabled: "disabled" == f ? "true" : "false", title: this.title, titleJs: j.gecko && !j.hc ? "" : (this.title || "").replace("'", ""), hasArrow: this.hasArrow ? "true" : "false", keydownFn: q, focusFn: r, clickFn: l, style: CKEDITOR.skin.getIconStyle(h, "rtl" == a.lang.dir, this.icon, this.iconOffset), arrowHtml: this.hasArrow ? o.output() : "" };
                p.output(f, b);
            ...
            init: function(a) {
                ...
                a.on("uiSpace", function(c) {
                    if (c.data.space == a.config.toolbarLocation) {
                        c.removeListener();
                        a.toolbox = new u;
                        var d = CKEDITOR.tools.getNextId(), b = ['<span id="', d, '" class="cke_voice_label">', a.lang.toolbar.toolbars, "</span>", '<span id="' + a.ui.spaceId("toolbox") + '" class="cke_toolbox" role="group" aria-labelledby="', d, '" onmousedown="return false;">'], d = !1 !== a.config.toolbarStartupCollapsed, e, j;
    ...
    (function() {
        function i(b, f) {
            var g = {},
                c = [],
                e = { nbsp: " ", shy: "­", gt: ">", lt: "<", amp: "&", apos: "'", quot: '"' },
        ...
        CKEDITOR.plugins.add("entities", {
            afterInit: function(b) {
                ...
                function g(b) { return"force" == c.entities_processNumerical || !a[b] ? "&#" + b.charCodeAt(0) + ";" : a[b] }
                ...
                if (b = (b = b.dataProcessor) && b.htmlFilter) {
                    ...
                    b.addRules({ text: function(a) { return a.replace(j, f).replace(d, g) } }, { applyToAll: !0, excludeNestedEditable: !0 });
                }
            }
        });
    })();
    ...
    (function() {
        function k(a) {
            ...
            (CKEDITOR.env.gecko || CKEDITOR.env.ie && "CSS1Compat" == e.document.$.compatMode) && this.attachListener(this, "keydown", function(a) {
                ...
                if (b == 33 || b == 34)
                    if (CKEDITOR.env.ie)setTimeout(function() { e.getSelection().scrollIntoView() }, 0);
    ...
    (function() {
        function E(b, k, e) {
            function d(d) { if ((a = c[d ? "getFirst" : "getLast"]()) && (!a.is || !a.isBlockBoundary()) && (m = k.root[d ? "getPrevious" : "getNext"](CKEDITOR.dom.walker.invisible(!0))) && (!m.is || !m.isBlockBoundary({ br: 1 })))b.document.createElement("br")[d ? "insertBefore" : "insertAfter"](a) }

            for (var f = CKEDITOR.plugins.list.listToArray(k.root, e), g = [], i = 0; i < k.contents.length; i++) {
                var h = k.contents[i];
                if ((h = h.getAscendant("li", !0)) && !h.getCustomData("list_item_processed"))
        ...
        function a(b, k, e, d) { for (var f, g; f = b[d ? "getLast" : "getFirst"](F);)(g = f.getDirection(1)) !== k.getDirection(1) && f.setAttribute("dir", g), f.remove(), e ? f[d ? "insertBefore" : "insertAfter"](e) : k.append(f, d) }
        ...
        function w(b) { return(b = b.getLast(q)) && b.type == CKEDITOR.NODE_ELEMENT && b.getName() in r ? b : null }

        var r = { ol: 1, ul: 1 }, G = CKEDITOR.dom.walker.whitespaces(), D = CKEDITOR.dom.walker.bookmark(), q = function(b) { return!(G(b) || D(b)) }, v = CKEDITOR.dom.walker.bogus();
            ...
            arrayToList: function(b, k, e, d, f) {
                ...
                for (var g, i = b[e].parent.getDocument(), h = new CKEDITOR.dom.documentFragment(i), c = null, a = e, m = Math.max(b[e].indent, 0), j = null, n, l, p = d == CKEDITOR.ENTER_P ? "p" : "div";;) {
                    ...
                    if (o.indent == m) {
                        ...
                        o = b[a - 1].element.getDirection(1), a = CKEDITOR.plugins.list.arrayToList(b, null, a, d, o != n ? n : null), !j.getChildCount() && (CKEDITOR.env.needsNbspFiller && 7 >= i.$.documentMode) && j.append(i.createText(" ")),
                        ...
                        if (!c.getCustomData("list_block")) {
                            ...
                            for (var j = b.elementPath(c), a = j.elements, m = 0, j = j.blockLimit, n, l = a.length - 1; 0 <= l && (n = a[l]); l--)
                                if (r[n.getName()] && j.contains(n)) {
                                    ...
                                    (a = n.getCustomData("list_group_object")) ? a.contents.push(c) : (a = { root: n, contents: [c] },
                    ...
                    if (a = f.shift(), this.state == CKEDITOR.TRISTATE_OFF)
                        if (r[a.root.getName()]) {
                            ...
                            for (c = 0; c < h.contents.length; c++)
                                if (l = h.contents[c], (l = l.getAscendant("li",
                            ...
                            for (c = 0; c < j && (m = a.listNode.getChild(c)); c++)
                                m.getName() ==
                                    this.type && g.push(m);
                ...
                b.blockless || (b.addCommand("numberedlist", new x("numberedlist", "ol")), b.addCommand("bulletedlist",
                    ...
                    if (b.mode == "wysiwyg" && e in { 8: 1, 46: 1 }) {
                        ...
                        if (f && f.collapsed) {
                            ...
                            c.evaluator = function(a) { return q(a) && !v(a) };
