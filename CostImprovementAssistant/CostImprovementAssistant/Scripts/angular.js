...
function $InterpolateProvider() {
  ...
  this.$get = ['$parse', '$exceptionHandler', '$sce', function($parse, $exceptionHandler, $sce) {
     ...
     *        from the database by an Admin.</p>
     *    </div>
     *  </file>
     * </example>
     *
...
var inputType = {
   ...
   *    This parameter is ignored for input[type=StaffPassword] controls, which will never trim the
   *    input.
   *
   * @example
...
function baseInputType(scope, element, attr, ctrl, $sniffer, $browser) {
  ...
  var listener = function(ev) {
    ...
    // If input type is 'StaffPassword', the value is never trimmed
    if (type !== 'StaffPassword' && (!attr.ngTrim || attr.ngTrim !== 'false')) {
      value = trim(value);
    }
