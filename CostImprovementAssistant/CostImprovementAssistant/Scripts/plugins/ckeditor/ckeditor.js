...
(function() {
    ...
    window.CKEDITOR || (window.CKEDITOR = function() {
        var a = {
                ...
                domReady: function() {
                    ...
                    function d() { for (var d; d = a.shift();)d() }
    ...
    CKEDITOR.event || (CKEDITOR.event = function() {}, CKEDITOR.event.implementOn = function(a) {
        ...
        return{
            ...
            on: function(b, d, h, e, n) {
                ...
                function j() { q.removeListener(b, d) }
            ...
            fire: function() {
                var b = 0, d = function() { b = 1 }, a = 0, g = function() { a = 1 };
    ...
    (function() {
        ...
        CKEDITOR.tools = {
            ...
            cssStyleToDomStyle: function() {
                ...
                return function(d) { return d == "float" ? a : d.replace(/-./g, function(d) { return d.substr(1).toUpperCase() }) };
            }(),
    ...
    (function() {
        ...
        function e(a, b) { return"#" + a.$.id + " " + b.split(/,\s*/).join(", #" + a.$.id + " ") }
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            removeStyle: function(a) {
                ...
                if (!b.removeProperty && (a == "border" || a == "margin" || a == "padding")) {
                    ...
                    for (var b = [], i = 0; i < c.length; i++)
                        if (e)for (var j = 0; j < e.length; j++)b.push([a, c[i], e[j]].join("-"));
            ...
            scrollIntoParent: function(a, b, c) {
                ...
                function u(a, b) { return parseInt(a.getComputedStyle("margin-" + b) || 0, 10) || 0 }
    ...
    (function() {
        function a(a, b) {
            ...
            if (a && !this._.guardRTL) {
                ...
                this._.guardRTL = function(a, b) { return(!b || !g.equals(a)) && (!j || !a.equals(j)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root)) };
            }
            var n = a ? this._.guardRTL : this._.guardLTR;
            k = l ? function(a, b) { return n(a, b) === false ? false : l(a, b) } : n;
            ...
            enlarge: function(a, b) {
                ...
                case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                    ...
                    if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
                        ...
                        k.evaluator = function(a) { return!H(a) && !C(a) };
    ...
    (function() {
        ...
        function u(a) { return a.type == CKEDITOR.NODE_ELEMENT && (a.name == "br" || t.$block[a.name]) }
        ...
        function k(a) { return function(b) { return y(b, a) } }

        function l(a) { return function(b, c) { c[a](b) } }
    ...
    (function() {
        CKEDITOR.lang = {
            ...
            detect: function(a, e) {
                ...
                CKEDITOR.lang.detect = d ? function() { return d } : function(a) { return a };
                return d || a;
            }
        };
    })();
    CKEDITOR.scriptLoader = function() {
        ...
        return{
            load: function(b, c, d, h) {
                ...
                g && (b = [b]);
                d || (d = CKEDITOR);
                var n = b.length, i = [], j = [], o = function(a) { c && (g ? c.call(d, a) : c.call(d, i, j)) };
                if (n === 0)o(true);
                else {
                    var q = function(a, b) {
                            (b ? i : j).push(a);
    ...
    (function() {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml = function(d, h, g) {
            ...
            function i() { for (; y.length;)o(y.shift(), m) }
            ...
            u.onCDATA = function(a) { m.add(new CKEDITOR.htmlParser.cdata(a)) };
    ...
    (function() {
        ...
        function h(a) { return a && (a.type == CKEDITOR.NODE_ELEMENT && a.name in t || a.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT) }
        ...
        function q(a) { return a.replace(Q, function(a, b) { return decodeURIComponent(b) }) }

        function s(a) { return a.replace(/<\!--(?!{cke_protected})[\s\S]+?--\>/g, function(a) { return"<\!--" + m + "{C}" + encodeURIComponent(a).replace(/--/g, "%2D%2D") + "--\>" }) }

        function u(a) { return a.replace(/<\!--\{cke_protected\}\{C\}([\s\S]+?)--\>/g, function(a, b) { return decodeURIComponent(b) }) }
        ...
        function p(a,
            b) {
            for (var c = [], d = b.config.protectedSource, e = b._.dataStore || (b._.dataStore = { id: 1 }), f = /<\!--\{cke_temp(comment)?\}(\d*?)--\>/g, d = [/<script[\s\S]*?<\/script>/gi, /<noscript[\s\S]*?<\/noscript>/gi].concat(d), a = a.replace(/<\!--[\s\S]*?--\>/g, function(a) { return"<\!--{cke_tempcomment}" + (c.push(a) - 1) + "--\>" }), k = 0; k < d.length; k++)
        ...
        var y = /(?:&nbsp;|\xa0)$/,
            ...
            r = { attributeNames: [[/^on/, "data-cke-pa-on"], [/^data-cke-expando$/, ""]] },
            L = {
                elements: {
                    embed: function(a) {
                        var b = a.parent;
        ...
        if (CKEDITOR.env.ie)A.attributes.style = function(a) { return a.replace(/(^|;)([^\:]+)/g, function(a) { return a.toLowerCase() }) };
    ...
    (function() {
        ...
        CKEDITOR.template = function(e) {
            if (a[e])this.output = a[e];
                ...
                var b = e.replace(/'/g, "\\'").replace(/{([^}]+)}/g, function(a, b) { return"',data['" + b + "']==undefined?'{" + b + "}':data['" + b + "'],'" });
    ...
    (function() {
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                insertText: function(a) {
                    ...
                    a = a.replace(/\n/g, "<br>");
                    b || (a = a.replace(RegExp("<br>(?=</" + c + ">)"), function(a) { return e.repeat(a, 2) }));
                    a = a.replace(/^ | $/g, "&nbsp;");
                ...
                insertElementIntoSelection: function(a) {
                    ...
                    if (this.insertElementIntoRange(a, d)) {
                        ...
                        if (k)
                            if ((k = a.getNext(function(a) { return c(a) && !i(a) })) && k.type == CKEDITOR.NODE_ELEMENT && k.is(CKEDITOR.dtd.$block))k.getDtd()["#"] ? d.moveToElementEditStart(k) : d.moveToElementEditEnd(a);
                ...
                setup: function() {
                    ...
                    this.attachListener(a, "beforeGetData", function() {
                        var b = this.getData();
                        this.is("textarea") || a.config.ignoreEmptyParagraph !== false && (b = b.replace(j, function(a, b) { return b }));
                        a.setData(b, null, 1);
                    }, this);
                    ...
                    this.on("focus", function() { this.hasFocus = true }, null, null,
                        -1);
        ...
        var s = function() {
                ...
                function d(b) { return b && a(b) && (b.is(g.$removeEmpty) || b.is("a") && !b.isBlockBoundary()) }
    ...
    (function() {
        ...
        function c(a) {
            function b(c, e) { return!c || c.type == CKEDITOR.NODE_TEXT ? false : a.clone()["moveToElementEdit" + (e ? "End" : "Start")](c) }
        ...
        function i(a) {
            ...
            a.fire("lockSnapshot");
            a.editable().append(b);
            var c = a.getSelection(), e = a.createRange(), d = c.root.on("selectionchange", function(a) { a.cancel() }, null, null, 0);
        ...
        CKEDITOR.on("instanceCreated", function(b) {
            ...
            d.on("contentDom", function() {
                ...
                k.attachListener(k, "mousedown", function() { o = 0 });
                ...
                if (i ? CKEDITOR.env.webkit || CKEDITOR.env.gecko : CKEDITOR.env.opera) {
                    var w;
                    k.attachListener(k, "mousedown", function() { w = 1 });
    ...
    (function() {
        ...
        CKEDITOR.editor.prototype.applyStyle = function(a) { a.checkApplicable(this.elementPath()) && x.call(a, this.getSelection()) };
        CKEDITOR.editor.prototype.removeStyle = function(a) { a.checkApplicable(this.elementPath()) && x.call(a, this.getSelection(), 1) };
...
*/
    ...
    CKEDITOR.plugins.add("dialogui", {
        onLoad: function() {
            ...
            CKEDITOR.dialog.addUIElement("StaffPassword", r);
    ...
    (function() {
        ...
        function y(b, a) {
            ...
            if (a.match(/^[^<]$/))return a;
            CKEDITOR.env.webkit && -1 < a.indexOf("<div>") && (a = a.replace(/^(<div>(<br>|)<\/div>)(?!$|(<div>(<br>|)<\/div>))/g, "<br>").replace(/^(<div>(<br>|)<\/div>){2}(?!$)/g, "<div></div>"), a.match(/<div>(<br>|)<\/div>/) && (a = "<p>" + a.replace(/(<div>(<br>|)<\/div>)+/g, function(a) { return c(a.split("</div><div>").length + 1) }) + "</p>"),
        ...
        function p(b, a) {
            b.enterMode ==
                CKEDITOR.ENTER_BR ? a = a.replace(/(<\/p><p>)+/g, function(a) { return CKEDITOR.tools.repeat("<br>", 2 * (a.length / 7)) }).replace(/<\/?p>/g, "") : b.enterMode == CKEDITOR.ENTER_DIV && (a = a.replace(/<(\/)?p>/g, "<$1div>"));
            return a;
        }
        ...
        CKEDITOR.plugins.add("entities", {
            afterInit: function(a) {
                ...
                if (a = (a = a.dataProcessor) && a.htmlFilter) {
                    ...
                    a.addRules({ text: function(a) { return a.replace(i, k).replace(f, c) } }, { applyToAll: !0 });
                }
            }
        });
    })();
            ...
            q(d,
            {
                ...
                lineChildren: [
                    q(B('<span title="' + a.editor.lang.magicline.title + '" contenteditable="false">&#8629;</span>', c), {
                        ...
                        looks: [
                            "top:-8px;" + CKEDITOR.tools.cssVendorPrefix("border-radius",
                ...
                exec: function(a) {
                    for (var h = a._.removeFormatRegex || (a._.removeFormatRegex = RegExp("^(?:" + a.config.removeFormatTags.replace(/,/g, "|") + ")$", "i")), e = a._.removeAttributes || (a._.removeAttributes = a.config.removeFormatAttributes.split(",")), f = CKEDITOR.plugins.removeformat.filter, k = a.getSelection().getRanges(1), l = k.createIterator(), c; c = l.getNextRange();) {
                        ...
                        var i = c.createBookmark(),
                            b = i.startNode,
                            j = i.endNode,
                            d = function(b) { for (var c = a.elementPath(b), e = c.elements, d = 1, g; (g = e[d]) && !g.equals(c.block) && !g.equals(c.blockLimit); d++)h.test(g.getName()) && f(a, g) && b.breakParent(g) };
                        d(b);
                        if (j) {
                            d(j);
        ...
        CKEDITOR.plugins.add("scayt", {
            ...
            init: function(a) {
                ...
                a.contextMenu && a.addMenuItems && a.contextMenu.addListener(function(b, c) {
                    ...
                    if (!i || !i.length) {
                        p(a, "no_sugg", h.noSuggestions, "scayt_no_sugg", { exec: function() {} }, "scayt_control", 1, true);
                        ...
                        for (var k = 0, r = i.length; k < r; k = k + 1) {
                            var q = "scayt_suggestion_" + i[k].replace(" ", "_"), t = function(a, b) { return{ exec: function() { f.replace(a, b) } } }(n, i[k]);
                            if (k < s) {
                        ...
                        if (j) {
                            a.addMenuItem("scayt_moresuggest", { label: h.moreSuggestions, group: "scayt_moresuggest", order: 10, getItems: function() { return g } });
                            e.scayt_moresuggest = CKEDITOR.TRISTATE_OFF;
                        }
                    }
                    if (o("all", l) || o("ignore", l)) {
                        p(a, "ignore", h.ignore, "scayt_ignore", { exec: function() { f.ignore(n) } }, "scayt_control", 2);
                    ...
                    if (o("all", l) || o("add", l)) {
                        p(a, "add_word", h.addWord, "scayt_add_word", { exec: function() { window.scayt.addWordToUserDictionary(n) } }, "scayt_control", 4);
