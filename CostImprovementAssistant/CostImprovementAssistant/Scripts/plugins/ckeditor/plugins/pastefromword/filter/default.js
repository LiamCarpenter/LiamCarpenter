...
(function() {
    ...
    var H = /^([.\d]*)+(em|ex|px|gd|rem|vw|vh|vm|ch|mm|cm|in|pt|pc|deg|rad|ms|s|hz|khz){1}?/i,
        D = /^(?:\b0[^\s]*\s*){1,4}$/,
        x = { ol: { decimal: /\d+/, "lower-roman": /^m{0,4}(cm|cd|d?c{0,3})(xc|xl|l?x{0,3})(ix|iv|v?i{0,3})$/, "upper-roman": /^M{0,4}(CM|CD|D?C{0,3})(XC|XL|L?X{0,3})(IX|IV|V?I{0,3})$/, "lower-alpha": /^[a-z]+$/, "upper-alpha": /^[A-Z]+$/ }, ul: { disc: /[l\u00B7\u2002]/, circle: /[\u006F\u00D8]/, square: /[\u006E\u25C6]/ } },
        ...
        E = CKEDITOR.plugins.pastefromword =
        {
            utils: {
                ...
                resolveList: function(a) {
                    ...
                    (b = b[0]))
                        return a.name = "cke:li", c.style && (c.style = E.filters.stylesFilter([
                    ...
                    for (var d = a.children, e, h = 0; h < d.length; h++)
                        if (e = d[h], e.name in CKEDITOR.dtd.$listItem) {
                            ...
                            E.filters.stylesFilter([
                                ["tab-stops", null, function(a) { (a = a.split(" ")[1].match(H)) && (t = CKEDITOR.tools.convertToPx(a[0])) }], 1 == c ? [
                                    "mso-list", null, function(a) {
                                        a = a.split(" ");
                    ...
                    for (var c = a.children, b, f, d, e, h, j, a = [], g, m, i, l, k, p, n = 0; n < c.length; n++)
                        if (b = c[n], "cke:li" == b.name)
                            if (b.name = "li", f = b.attributes, i = (i = f["cke:listsymbol"]) &&
                                i.match(/^(?:[(]?)([^\s]+?)([.)]?)$/), l = k = p = null, f["cke:ignored"])c.splice(n--, 1);
                            else {
                ...
                return{
                    ...
                    elements: {
                        ...
                        span: function(a) {
                            ...
                            if (e = (b = a.attributes) && b.style)
                                b.style = j([
                                    ["line-height"],
                                    [/^font-family$/, null, !o ? m(d.font_style, "family") : null], [/^font-size$/, null, !o ? m(d.fontSize_style, "size") : null], [/^color$/, null, !o ? m(d.colorButton_foreStyle, "color") : null], [/^background-color$/, null, !o ? m(d.colorButton_backStyle, "color") : null]
                                ])(e, a) || "";
                    ...
                    attributes: {
                        style: j(s ? [
                            ...
                            ], [/^clear$/], [/^border.*|margin.*|vertical-align|float$/, null, function(a, b) { if ("img" == b.name)return a }], [/^width|height$/, null, function(a, b) { if (b.name in { table: 1, td: 1, th: 1, img: 1 })return a }]
                        ] : [
                            [/^mso-/], [
