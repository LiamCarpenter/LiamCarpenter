...
(function() {
    ...
    var e = function() {
            ...
            return{
                postMessage: {
                    init: function(a) { document.addEventListener ? window.addEventListener("message", a, !1) : window.attachEvent("onmessage", a) },
                    send: function(a) {
    ...
    var x = function(b) { for (var c in b)b[c].instance.getElement().setText(a.LocalizationComing[c]) },
        y = function(b) {
            for (var c in b) {
        ...
        j,
        p;
    a.framesetHtml = function(b) { return'<iframe src="' + a.templatePath + '" id=' + a.iframeNumber + "_" + b + ' frameborder="0" allowtransparency="1" style="width:100%;border: 1px solid #AEB3B9;overflow: auto;background:#fff; border-radius: 3px;"></iframe>' };
    ...
    a.setHeightFrame = function() { document.getElementById(a.iframeNumber + "_" + a.dialog._.currentTabId).style.height = "240px" };
    ...
    var q = function(a) {
            ...
            i.id = f;
            e || d.appendChild(i);
            return{ setDisable: function() { i.style.display = "none" }, setEnable: function() { i.style.display = "block" } };
        },
        z = function(b, c, d) {
        ...
        s = function() { a.dialog.hidePage("Thesaurus") },
        m = function() { a.dialog.hidePage("GrammTab") },
        o = function() { a.dialog.showPage("SpellTab") },
                                            ...
                                            children: [
                                                {
                                                    ...
                                                    onClick: function() { "file:" == document.location.protocol ? alert("WSC: Options functionality is disabled when runing from file system") : b.openDialog("options") }
                                                }
                                            ]
                                        }
                                    ]
                                    ...
                                    children: [
                                        {
                                            type: "vbox",
                                            children: [
                                                { type: "text", id: "text", label: "Change to:", labelLayout: "horizontal", labelStyle: "font: 12px/25px arial, sans-serif;", inputStyle: "float: right; width: 200px;", "default": "", onShow: function() { a.textNode.GrammTab = this }, onHide: function() { this.reset() } }, {
                                                    type: "html",
                                                    id: "html_text",
                                            ...
                                            type: "vbox",
                                            children: [
                                                { type: "button", id: "ChangeTo", label: "Change to", title: "Change to", style: "width: 133px; float: right;", onLoad: function() { this.getElement().setAttribute("title-cmd", this.id) }, onClick: c }, {
                                                    type: "button",
                                                    id: "IgnoreWord",
                                                    label: "Ignore word",
                                                    title: "Ignore word",
                            ...
                            children: [
                                {
                                    ...
                                    align: "right",
                                    width: "30%",
                                    children: [{ type: "vbox", id: "rightCol_col__left", children: [{ type: "button", id: "FinishChecking", label: "Finish Checking", title: "Finish Checking", style: "width: 100%;", onLoad: function() { this.getElement().setAttribute("title-cmd", this.id) }, onClick: c }] }]
                                }
                            ]
                        }
                    ]
                                            ...
                                            children: [
                                                {
                                                    ...
                                                    widths: ["65%", "35%"],
                                                    children: [
                                                        { type: "text", id: "ChangeTo", label: "Change to:", labelLayout: "horizontal", inputStyle: "width: 160px;", labelStyle: "font: 12px/25px arial, sans-serif;", "default": "", onShow: function() { a.textNode.Thesaurus = this }, onHide: function() { this.reset() } },
                                                    ...
                                                    type: "hbox",
                                                    children: [
                                                        { type: "select", id: "categories", label: "Categories:", labelStyle: "font: 12px/25px arial, sans-serif;", size: "5", inputStyle: "width: 180px; height: auto;", items: [], onShow: function() { a.selectNode.categories = this }, onHide: function() { this.clear() }, onChange: function() { a.buildOptionSynonyms(this.getValue()) } },
                                                        {
                                                            type: "select",
                                                            id: "synonyms",
                                                            label: "Synonyms:",
                                                            ...
                                                            onChange: function() { a.textNode.Thesaurus.setValue(this.getValue()) }
                                                        }
                                                    ]
                                                }
                                            ]
                                                    ...
                                                    children: [
                                                        {
                                                            ...
                                                            "default": "",
                                                            onClick: function() { d[this.id] = !this.getValue() ? 0 : 1 }
                                                    ...
                                                    children: [
                                                        {
                                                            ...
                                                            widths: ["50%", "50%"],
                                                            children: [
                                                                { type: "button", id: "create", label: "Create", title: "Create", style: "width: 100%;", onLoad: function() { this.getElement().setAttribute("title-cmd", this.id) }, onShow: function() { this.getElement().setText(a.LocalizationComing.Create) }, onClick: h }, {
                                                                    type: "button",
                                                                    id: "restore",
                                                                    label: "Restore",
                                                                    title: "Restore",
                                                            ...
                                                            widths: ["50%", "50%"],
                                                            children: [
                                                                { type: "button", id: "rename", label: "Rename", title: "Rename", style: "width: 100%;", onLoad: function() { this.getElement().setAttribute("title-cmd", this.id) }, onShow: function() { this.getElement().setText(a.LocalizationComing.Rename) }, onClick: h }, {
                                                                    type: "button",
                                                                    id: "delete",
                                                                    label: "Remove",
                                                                    title: "Remove",
