...
if (!document.createElement('canvas').getContext) {
   ...
   */
        ...
        canvasGradient.prototype.addColorStop = function(aOffset, aColor) {
        ...
        function domException(s) {
            this.code = this[s];
            this.message = s + ': DOM Exception ' + this.code;
        }

        var p = domException.prototype = new Error;
        p.INDEX_SIZE_ERR = 1;
        ...
        // set up externs
        G_vmlCanvasManager = gVmlCanvasManager;
