...
namespace CostImprovementAssistant.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "CategoryName,TrustCode")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "CategoryName,TrustCode")] Category category)
        {
            if (ModelState.IsValid)
            {
