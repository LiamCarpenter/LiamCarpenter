...
namespace CostImprovementAssistant.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "DepartmentName,TrustCode")] Department department)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "DepartmentName,TrustCode")] Department department)
        {
            if (ModelState.IsValid)
            {
