...
Partial Public Class CommissionChase
    ...
    Private Shared Function makeCommissionChaseFromRowInvoice( _
        ...
        Return New CommissionChase( _
                clsUseful.notString(r.Item("invoiceid")))
    End Function
    ...
    Private Shared Function makeCommissionChaseFromRow( _
        ...
        Return New CommissionChase( _
                clsUseful.notInteger(r.Item("commissionChaseID")), _
                clsUseful.notString(r.Item("invoiceid")), _
                clsUseful.notString(r.Item("date1")), _
                clsUseful.notString(r.Item("date2")), _
                clsUseful.notString(r.Item("date3")), _
                clsUseful.notString(r.Item("date4")), _
                clsUseful.notString(r.Item("date5")), _
                clsUseful.notString(r.Item("dateSpecial")), _
                clsUseful.notString(r.Item("venuename")), _
                clsUseful.notString(r.Item("invoiceamount")), _
                clsUseful.notString(r.Item("commnet")), _
                clsUseful.notString(r.Item("commvat")), _
                clsUseful.notString(r.Item("commtotal")), _
                clsUseful.notString(r.Item("invoicedate")), _
                clsUseful.notString(r.Item("eventdate")), _
                clsUseful.notString(r.Item("emailto")), _
                clsUseful.notString(r.Item("sentBy")))
    End Function
