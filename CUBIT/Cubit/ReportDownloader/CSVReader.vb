...
Partial Public Class dataImport
    Public Sub New( _
        ...
        ByVal pInvoiceLineDetailID As String,
        ByVal pPassengerFirstName As String,
        ByVal pPassengerLastName As string) 'R2.9.1 SA - added InvoiceLineDetailID
        ...
        mPassengerFirstName = pPassengerFirstName
        mPassengerLastName = pPassengerLastName
    End Sub
    ...
    Private mPassengerFirstName As String
    Private mPassengerLastName As String 
    ...
    Public Property PassengerFirstName As String 
    Get
            Return mPassengerFirstName
    End Get
    Set(value As String)
            mPassengerFirstName = value 
    End Set
    End Property

    Public Property PassengerLastName As String 
    Get
            Return mPassengerLastName
    End Get
    Set(value As String)
            mPassengerLastName = value 
    End Set
    End Property
...
Public Class CSVReader
    ...
    Public Function Main() As Boolean
        ...
        Try
            ...
            '  
            If IO.File.Exists(getConfig("downloadedfiles") & Format(Now, "dd-MM-yyyy") & ".csv") Then
                If Not importFile(getConfig("downloadedfiles") & Format(Now, "dd-MM-yyyy") & ".csv") Then
                    blnOk = False
                End If
            End If
    ...
    Private Enum FieldIndexes
        ...
        Arrivaldate = 4
        LeadPassengername = 5
        LeadPassengerFirstName  = 5
        LeadPassengerLastName = 6
        Currency = 12
        Totalamount = 13
        Vatamount = 14
        Vatrate = 15
        ...
        Roomdetails = 22
        Company = 23
        Confermainvoicenumber = 24
        Category = 25
        Supplierinvoice = 26
        GuestPNR = 28
        ref1 = 29 ' lastmodified
        BookedDate = 30
        OutofPolicyReason = 31
        Last4Digits = 32
        TravellerEmail = 33
        ...
        BookerEmail = 34
        UserBooker = 35 'booker name
        Costcode = 36
        ref2 = 37 'now billinstructions
        ref3 = 38 'now comments
        NYSBookerinitials = 39
        AICol6 = 40
        AICol7 = 41
        AICol8 = 42
        AICol9 = 43
    ...
    Public Function importFile(ByVal pstrFile As String) As Boolean
        Try
                ...
                If line.Count = 1 Then
                    ...
                    If item(Values, 0).ToLower <> "transactionnumber" Then
                        ...
                        Dim v As New dataImport(item(Values, FieldIndexes.Transactionnumber), _
                                                ...
                                                item(Values, FieldIndexes.InvoiceLineDetailID), _
                                                item(Values, FieldIndexes.LeadPassengerFirstName), _
                                                item(Values, FieldIndexes.LeadPassengerLastName)) 'R2.9.1 SA added InvoiceLineDetailID
                        dinosaurs.Add(v)
                    ...
                    If line.Count > 1 Then
                        If item(line, 0).ToLower <> "transactionnumber" Then
                            ...
                            Dim v As New dataImport(item(line, FieldIndexes.Transactionnumber), _
                                                    ...
                                                    item(line, FieldIndexes.InvoiceLineDetailID), _
                                                    item(line, FieldIndexes.LeadPassengerFirstName), _
                                                    item(line, FieldIndexes.LeadPassengerLastName)) 'R2.9.1 SA - added InvoiceLineDetailID
                            dinosaurs.Add(v)
                        End If
                    End If
                End If
            ...
            Dim Sorter As New Sorter(Of dataImport)
        ...
        For Each dino As dataImport In dinosaurs
            ...
            Else
                Try
                    ...
                    'End If
                    strpassengername = dino.PassengerLastName.Trim.ToLower & "/" & dino.PassengerFirstName.Trim.ToLower
                    ...
                    If Not blnIsDuplicate Then
                        ...
                        checkLength("Passengername", dino.PassengerFirstName & " " & dino.PassengerLastName, 200)
                        ...
                        If strRet.ToUpper = "LATEROOMS.COM" Then
                            ...
                            'MK - 27/01/2015 Added EXPEDIA AFFILIATE to the expdia fee
