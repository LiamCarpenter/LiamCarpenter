...
Public Class SendEmail
    ...
    Public Shared Sub send(ByVal pstrFrom As String, _
        ...
        Try
            ...
            SmtpMail.Host = "smtpcorp.com"
            SmtpMail.Credentials = New System.Net.NetworkCredential("nyscorporate", "Z0r6Ev#2v0")
            'SmtpMail.Host = "office.nyscorporate.com" Removed to use new details within the webconfig.
        ...
        Catch ex As Exception
            ...
            log.Info("Error sending Mail " & ex.Message)
            MailMsg = Nothing
        End Try
    End Sub
